...
<?php 
	...
	//MOSTRAR DATOS DEL USUARIO EN EL FORMULARIO DE EDICION
	if (empty($_GET['id'])) 
	{
	...
	if ($result_sql == 0) 
	{
		...
		while ($data = mysqli_fetch_array($sql)) {
			...
			//con esta condicion extraemos el rol del usuario para reflejarlo en el formulario de edicion...
			if ($idrol == 1) {
	...
	<section id="container">
		...
		<div class="form_register">
			...
			<form action="" method="POST">
				...
				<select name="rol" id="rol" class="notItemOne"><!--CLASE PARA EVITAR REPETIR EL ROL EN LA SELECCION DE ROLES-->
